...
def fractions_subtract_page(request):
    ...
    if (state == 0):  # the initial state
        ...
        if(myutil.compare_fractions(fraction1[0], fraction1[1], fraction1[2], fraction2[0], fraction2[1], fraction2[2]) >= 0):
            ...
            context['number11'] = fraction2[0]
            context['number12'] = fraction2[1]
            context['number13'] = fraction2[2]
            context['number21'] = fraction1[0]
            context['number22'] = fraction1[1]
            context['number23'] = fraction1[2]
        context['flag'] = '='
        context['cmd'] = 'Submit'
        return render(request, 'grade5/grade5fractions_subtract.html', context)
    if (state == 1):  # which means user cliked submit in the initial page
        ...
        addition_result = myutil.subtract_fractions(num11, num12, num13, num21, num22, num23)
        successful = 0
